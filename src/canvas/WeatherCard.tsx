...
const WeatherCard: FC<Props> = ({ location, wind, humidity, temperature }) => {
  return (
          ...
          <div className="flex justify-between items-center">
            <div className="space-y-2">
              ...
              <span className="flex space-x-2 items-center">
                ...
                <span>{humidity ? humidity : null}%</span>
              </span>
            </div>
            <div>
              <h1 className="text-6xl"> {temperature ? temperature : null}° </h1>
            </div>
          </div>
        </div>
      </div>
